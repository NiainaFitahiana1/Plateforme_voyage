    ...
    <div class="my-2 w-full bg-black border border-gray-200 rounded-xs shadow-sm dark:bg-black dark:border-neutral-700">
        <div class="p-7 md:px-20">
          <div class="text-center">
            <h1 class="block text-2xl font-bold text-white dark:text-white">Création Article</h1>
          </div>
          ...
          <div class="mt-1">
            ...
            <div class="md:col-span-2 "> 
                <div
                id="FileUpload"
                class="relative mb-5.5 block w-full cursor-pointer appearance-none rounded border border-dashed border-primary bg-gray px-4 py-4 dark:bg-meta-4 sm:py-7.5 text-white">
                <input
                  type="file"
                  accept="image/*"
                  name="photo"
