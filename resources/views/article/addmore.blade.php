...
<div class="px-6 h-full w-full items-center">
    <div class="w-full bg-neutral-900 border border-gray-200 rounded-xs shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
        <div class="p-7 md:px-20">
          <div class="text-center">
            <h1 class="block text-2xl font-bold text-gray-100 dark:text-white">{{$article->titre}}</h1>
          </div>
          ...
          <div class="mt-2">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="col-span-2">
                    ...
                    <div class="hs-dropdown relative inline-flex ml-3 [--auto-close:inside]">
                        <button class="hs-dropdown-toggle relative inline-flex items-center gap-x-2 bg-slate-900 hover:bg-slate-950 py-2 px-4 rounded-md text-xs mt-1 text-white"  id="hs-dropdown-custom-trigger" type="button">
                ...
                <div class="md:col-span-2 grid md:grid-cols-2 gap-2">
                    ...
                    <button class="py-3 px-10 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Suivant</button>
                </div>
              </div>
            </div>
            <!-- End Form -->
            ...
            <div>
                ...
                <div class="md:col-span-2 grid md:grid-cols-2 gap-2">
                    <a href="" class="py-3 px-10 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-400 bg-transparent text-white hover:bg-transparent focus:outline-none focus:bg-black disabled:opacity-50 disabled:pointer-events-none">Retour</a>
                    <button type="submit" class="py-3 px-10 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Suivant</button>
                </div>
